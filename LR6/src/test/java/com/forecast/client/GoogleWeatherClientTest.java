...
class GoogleWeatherClientTest {
    ...
    @Test
    void getProviderType_ReturnsGoogleWeather() {
        assertEquals(WeatherProvider.GOOGLE_WEATHER, googleWeatherClient.getProviderType());
    }
    ...
    void getCurrentTemperature_ReturnsTemperature_WhenResponseIsValid() {
        ...
        BigDecimal result = googleWeatherClient.getCurrentTemperature(lat, lon);
    ...
    void getCurrentTemperature_ThrowsException_WhenStatusIsNotOk() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> googleWeatherClient.getCurrentTemperature(lat, lon));
    ...
    void getCurrentTemperature_ThrowsException_WhenTemperatureNodeIsMissing() {
        ...
        assertEquals("Missing temperature data in GoogleWeather response", exception.getMessage());
    }
    ...
    void getCurrentTemperature_ThrowsException_WhenJsonIsInvalid() {
        ...
        assertTrue(exception.getMessage().contains("Failed to parse GoogleWeather current weather response"));
    }
    ...
    void getForecast_ThrowsException_WhenStatusIsNotOk() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class,
                () -> googleWeatherClient.getForecast(lat, lon));
